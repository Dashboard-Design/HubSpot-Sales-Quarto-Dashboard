...
def generate_data(country, company_rows=221, contacts_per_company=9, deals_per_company=20, products_per_deal=4 ):
...
df_list = [generate_data(country) for country in g7_countries]
result = pd.concat(df_list, ignore_index=True)

# Write the generated data to an Excel file
result.to_excel(r"F:/# My-Freelance-World/# GitHub Projects/HubSpot Sales Quarto Dashboard/Hubspot python data generation/hubspot_dummy_data.xlsx", index=False)